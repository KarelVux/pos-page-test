...
namespace WebApp.ApiControllers.Management
{
    ...
    public class SettlementsController : ControllerBase
    {
        ...
        /// DTO mapper
        /// </summary>
        private readonly Public.DTO.Mappers.Management.SettlementMapper _mapper;
        ...
        {
            _bll = bll;
            _mapper = new Public.DTO.Mappers.Management.SettlementMapper(autoMapper);
        }
        ...
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<IActionResult> PutSettlement(Guid id, PublicDTO.Settlement element)
        {
            if (id != element.Id)
            {
                return BadRequest();
            ...
            try
            {
                _bll.SettlementService.Update(_mapper.Map(element)!);
